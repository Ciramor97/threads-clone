<template>
  <div id="CreatePost" class="fixed w-full h-full bottom-0 z-50">
    <div class="bg-black h-full w-full text-white overflow-auto">
      ...
      >
        ...
        <span class="text-base font-semibold">New Thread</span>
      </div>
      <div
        id="Post"
        ...
        <div class="py-2 w-full">
          <div class="flex items-center">
            <div v-if="user" class="flex items-center text-white">
              ...
              />
              <div class="ml-2 font-semibold text-[18px] text-white">
